[[1. 什么是 PostgreSQL 分区？](PostgreSQL%20分区.md#1.%20什么是%20PostgreSQL%20分区？)
[2. 为什么要分区](PostgreSQL%20分区.md#2.%20为什么要分区)
[3. 分区类型](PostgreSQL%20分区.md#3.%20分区类型)
[4. 分区核心机制（分区裁剪）](PostgreSQL%20分区.md#4.%20分区核心机制（分区裁剪）)
[5. 索引与分区的关系](PostgreSQL%20分区.md#5.%20索引与分区的关系)
[6. 全局索引？](PostgreSQL%20分区.md#6.%20全局索引？)
[7. 分区的限制与注意事项](PostgreSQL%20分区.md#7.%20分区的限制与注意事项)
